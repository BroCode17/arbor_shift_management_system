import { decimal, varchar, time, timestamp, uuid, integer, pgTable, date, text } from "drizzle-orm/pg-core";
...
export const availableShiftsSchema = pgTable('available_shifts', {
    ...
    status: varchar('status', { enum: ['open', 'filled', 'cancelled'] }).default('open'), // open, filled, cancelled
